 ...
 * Provides CRUD operations and custom queries for song data access.
 */
@Repository
public interface SongRepository extends JpaRepository<Song, Long> 
{
    ...
    @Query("SELECT s FROM Song s " +
           "WHERE s.durationSeconds BETWEEN :minDuration AND :maxDuration " +
           "ORDER BY s.durationSeconds ASC")
    List<Song> findByDurationRange(
