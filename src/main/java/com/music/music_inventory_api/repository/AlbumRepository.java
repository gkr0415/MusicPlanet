 ...
 * Provides CRUD operations and custom queries for album data access.
 */
@Repository
public interface AlbumRepository extends JpaRepository<Album, Long> 
{
    ...
    /**
     * Custom query to search albums by genre and price range.
    ...
    List<Album> searchByGenreAndPriceRange(
    ...
    /**
     * Custom query to search albums by title or artist name.
     * One of the required @Query examples.
     *
     ...
     */
    @Query("SELECT a FROM Album a " +
           "WHERE a.stockQuantity < :threshold AND a.stockQuantity > 0 " +
