 ...
 * Provides CRUD operations and custom queries for order data access.
 */
@Repository
public interface OrderRepository extends JpaRepository<Order, Long> 
{
    ...
    /**
     * Custom query to get customer order statistics.
     * One of the required @Query examples.
     * Returns total order count, total amount spent, and average order value.
     *
