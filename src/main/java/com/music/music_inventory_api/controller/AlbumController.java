 ...
 * Provides endpoints for CRUD operations and search capabilities.
 */
@RestController
...
public class AlbumController {
    ...
    @Operation(
            ...
            description = "Creates a new album with the provided information. Requires valid artist ID and at least one genre ID."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Retrieves detailed album information including songs, artist details, and genres"
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Retrieves all albums with pagination support. Default page size is 20."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Searches albums by title or artist name using a case-insensitive partial match"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<AlbumResponse>> searchAlbums(
            @Parameter(description = "Search query string", example = "Beatles", required = true)
    ...
    @Operation(
            ...
            description = "Retrieves all albums belonging to a specific genre"
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Albums retrieved successfully"),
    ...
    public ResponseEntity<List<AlbumResponse>> getAlbumsByGenre(
            @Parameter(description = "Genre ID", example = "1", required = true)
    ...
    @Operation(
            summary = "Get albums by price range",
            description = "Retrieves albums within a specific price range (inclusive)"
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Albums retrieved successfully"),
    ...
    public ResponseEntity<List<AlbumResponse>> getAlbumsByPriceRange(
            @Parameter(description = "Minimum price", example = "10.00", required = true)
            @RequestParam("min") @NotNull @DecimalMin("0.0") BigDecimal minPrice,
            @Parameter(description = "Maximum price", example = "50.00", required = true)
            @RequestParam("max") @NotNull @DecimalMin("0.0") BigDecimal maxPrice) {
    ...
    @Operation(
            ...
            description = "Updates an existing album. All fields are optional; only provided fields will be updated."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Deletes an album by ID. This operation cannot be undone."
    )
    @ApiResponses(value = {
